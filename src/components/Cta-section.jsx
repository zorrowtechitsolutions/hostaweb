          ...
          <GlassWrapper variant="container" className="p-12 text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                className="rounded-full gap-2 h-12 px-8 text-base 
                bg-green-600 hover:bg-green-500 text-black border-0"
              >
      ...
      {open && (
        ...
        >
          ...
          <div
            ...
            border border-white/25 bg-white/15 backdrop-blur-xl 
            shadow-2xl p-6 space-y-4 text-center"
            onClick={(e) => e.stopPropagation()}
          >
            {/* 🔥 Apple-style depth boost */}
            ...
            <button
              ...
              justify-center rounded-full p-1 hover:bg-white/15 z-10"
            >
            ...
            <div className="relative z-10 mt-3 flex flex-col gap-3">
              ...
              <Button
                ...
                rounded-full h-11 text-sm font-medium 
              ...
              <Button
                ...
                className="w-full inline-flex items-center justify-center gap-2 
                rounded-full h-11 text-sm font-medium 
                text-white/70 border border-white/25 
                bg-white/5 backdrop-blur-md cursor-not-allowed"
              >
