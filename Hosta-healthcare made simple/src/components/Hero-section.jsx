...
import { Smartphone, Apple, X, WholeWordIcon, Globe } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-black">
                  Your Health. Your Hospital. <span className="text-green-600">One App.</span>
                </h1>
                ...
                <p className="text-sm text-slate-600 max-w-xl mx-auto lg:mx-0">
                  Hosta is released by <strong>Zorrowtech IT Solutions</strong> — visit <a
                    href="https://zorrowtech.in" target="_blank" rel="noopener noreferrer" className="underline">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                {/* Optional secondary button to open brand site directly */}
                <a
                  href="https://zorrowtech.in"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-full px-6 h-12 text-base font-medium text-slate-900 bg-white hover:bg-white/80 transition-colors shadow-sm border"
                >
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative">
                {/* GLASS PHONE */}
                <div className="w-72 h-[32rem] p-3 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-xl flex items-center justify-center overflow-hidden">
                  {/* PHONE SCREEN IMAGE */}
                  <img
                ...
                {/* GLOW BEHIND */}
                <div className="absolute -inset-6 bg-green-400/20 blur-3xl rounded-full -z-10" />
              </div>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="pt-3 border-t border-white/10 mt-4">
              <p className="text-xs text-white/60">
                Hosta is a product of <strong>Zorrowtech IT Solutions</strong>. Learn more at <a
                  href="https://zorrowtech.in" target="_blank" rel="noopener noreferrer" className="underline">
                  zorrowtech.in
                </a>
              </p>
